...
//TECH: More than 2 frames in flight adds latency
...
struct Vertex {
    ...
    static VkVertexInputBindingDescription getBindingDescription(){
        ...
        //NOTE: Instance rendering is also available
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions(){
        ...
        //NOTE: For some bizarre reason "format" is also described as color format
...
private:
    ...
    bool isDeviceSuitable(VkPhysicalDevice device){
        ...
        //NOTE: We are just looking for vulkan support therefore any GPU works
        return indices.isComplete() && extensionsSupported && swapChainAdequate;
    }

    /*TECH: There are three kinds of preoperties we need to check:
    ...
    void createLogicalDevice(){
        ...
        for (uint32_t queueFamily : uniqueQueueFamilies) {
            ...
            //NOTE: You shouldn't ever need more than one
    ...
    void createSwapChain(){
        ...
        /*TECH: imageArrayLayers specifies the amount of layers each image consists of.
         * This should always be one unless you are developing a stereoscopic 3D application*/
    ...
    //NOTE: Refer to page 78 for presentation mode specification
    //Refresh mode
    VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes){
        ...
        //NOTE: This mode is garanteed to be available
    ...
    void createGraphicsPipeline(){
        ...
        auto bindingDescriptio = Vertex::getBindingDescription();
        ...
        //NOTE: If set to VK_TRUE geometry never passes through rasterizer stage
        rasterizer.rasterizerDiscardEnable = VK_FALSE;
        //NOTE: Determines how fragments are generated for geometry
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex){
        ...
        //NOTE: Filters pixels from buffer
        VkRect2D scissor{};
        scissor.offset = {0, 0};
    ...
    void drawFrame(){
        /*NOTE: common set of steps to render a frame
         * Wait for the previous frame to finish
         * Acquire an image from the swap chain
         * Record a command buffer which draws the scene onto that image
         * Submit the recorded command buffer
         * Present the swap chin image*/

        /*NOTE: In Vulkan Synchronization of execution on the GPU is explicit.
         * Therefore many Vulkan API calls which start executing work on the
         * GPU are async*/

        /*NOTE:
         * Semaphores specify execution order of ops on the GPU
         * Fences keep CPU and GPU in sync with each-other
         * They are either unsignaled or signaled
         * They begin their life as unsignaled
         * Semaphores are automatically reseted after being signaled
         * Fences must be reset manually to set them back to unsignaled state*/

        /*NOTE: It's preferable not to block host unless necessary
         * prefer semaphores or other sync primitives over fences*/
    ...
    void cleanup(){
        ...
        //NOTE: Destroy surface before instance
